...
/// <summary>
/// Stores one Jetpack VFX scaling entry baked from Visual Preset Add Scaling authoring data.
/// </summary>
[InternalBufferCapacity(0)]
public struct PlayerRuntimeJetpackVfxScalingElement : IBufferElementData
{
    public FixedString128Bytes PayloadPath;
    public byte ValueType;
    public float BaseValue;
