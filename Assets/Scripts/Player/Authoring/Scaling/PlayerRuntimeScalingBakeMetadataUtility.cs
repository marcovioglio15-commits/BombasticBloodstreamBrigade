...
internal static class PlayerRuntimeScalingBakeMetadataUtility
{
    ...
    /// </summary>
    /// <param name="sourcePreset">Unscaled source progression preset.</param>
    /// <param name="baseValue">Raw interaction lock duration stored on the source preset.</param>
    /// <param name="formula">Enabled Add Scaling formula when present.</param>
    /// <returns>True when metadata was resolved from the source preset; otherwise false.</returns>
    ...
    /// </summary>
    /// <param name="sourcePreset">Unscaled source progression preset.</param>
    /// <param name="scheduleIndex">Schedule index inside the preset.</param>
    /// <param name="stepIndex">Step index inside the selected schedule sequence.</param>
    /// <param name="baseValue">Raw schedule-step value stored on the source preset.</param>
    /// <param name="formula">Enabled Add Scaling formula when present.</param>
    /// <returns>True when metadata was resolved from the source preset; otherwise false.</returns>
