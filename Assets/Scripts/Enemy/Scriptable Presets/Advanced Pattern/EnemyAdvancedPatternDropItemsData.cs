...
public sealed class EnemyExperienceDropPayload
{
    ...
    [Tooltip("Vertical world-space offset applied to the killed enemy position before experience drops spawn. Use negative values to place pickups closer to the floor.")]
    [SerializeField] private float groundHeightOffset = EnemyDropItemsSpawnSettingsDefaults.DefaultGroundHeightOffset;
...
public sealed class EnemyRecoveryDropPayload
{
    ...
    [Tooltip("Vertical world-space offset applied to the killed enemy position before recovery drops spawn. Use negative values to place pickups closer to the floor.")]
    [SerializeField] private float groundHeightOffset = EnemyDropItemsSpawnSettingsDefaults.DefaultGroundHeightOffset;
