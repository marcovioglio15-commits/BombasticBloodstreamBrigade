...
internal static class EnemyBombardierRequestUtility
{
                                                 ...
                                                 ref Random random)
    {
        ...
        switch (targetingMode)
        {
            case EnemyBombardierTargetingMode.RandomAroundEnemy:
                targetPosition = enemyPosition + ResolveRandomPlanarOffset(in bombardierConfig, ref random);
                break;

            case EnemyBombardierTargetingMode.RandomAroundPlayer:
                targetPosition = playerPosition + ResolveRandomPlanarOffset(in bombardierConfig, ref random);
                break;
        ...
        return EnemyBombardierMapSafetyUtility.ResolveMapSafeLandingPosition(targetPosition,
                                                                             enemyPosition,
                                                                             in bombardierConfig,
                                                                             navigationReady,
                                                                             in navigationGridState,
                                                     ...
                                                     ref Random random)
    {
        ...
        for (int bombIndex = 0; bombIndex < bombsPerLaunch; bombIndex++)
        {
            ...
            AddLaunchRequest(launchRequests,
                             ownerEntity,
                             enemyPosition,
                             landingPosition,
                             in bombardierConfig,
    ...
    private static void AddLaunchRequest(DynamicBuffer<EnemyBombardierLaunchRequest> launchRequests,
                                         ...
                                         DynamicBuffer<EnemyNavigationCellElement> navigationCells)
    {
        landingPosition = EnemyBombardierMapSafetyUtility.ResolveMapSafeLandingPosition(landingPosition,
                                                                                       enemyPosition,
                                                                                       in bombardierConfig,
                                                                                       navigationReady,
                                                                                       in navigationGridState,
