...
internal static class EnemyMasterPresetsPanelPresetUtility
{
    ...
    public static VisualElement BuildRightPane(EnemyMasterPresetsPanel panel)
    {
        ...
        ManagementToolScrollStateUtility.Attach(detailsRoot, EnemyMasterPresetsPanelSidePanelUtility.DetailsScrollOffsetStateKey);
        return rightPane;
    }
    ...
    public static void RefreshPresetList(EnemyMasterPresetsPanel panel)
    {
        ...
        if (panel.SelectedPreset == null || !panel.FilteredPresets.Contains(panel.SelectedPreset))
        {
            ...
            EnemyMasterPreset restoredPreset = EnemyMasterPresetsPanelSidePanelUtility.LoadPersistedSelectedPreset();
            EnemyMasterPreset initialPreset = restoredPreset != null && panel.FilteredPresets.Contains(restoredPreset)
                ? restoredPreset
