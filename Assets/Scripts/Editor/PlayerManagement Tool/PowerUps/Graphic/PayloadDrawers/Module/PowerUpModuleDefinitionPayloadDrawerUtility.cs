...
public static class PowerUpModuleDefinitionPayloadDrawerUtility
{
                                          ...
                                          bool showStolenOwnershipPolicy = true)
    {
        ...
        switch (moduleKind)
        {
            case PowerUpModuleKind.TriggerHoldCharge:
                PowerUpHoldChargePayloadDrawerUtility.Build(payloadContainer, payloadProperty);
                return;
    ...
    internal static void BuildLaserBeamPayloadUi(VisualElement payloadContainer,
    ...
    #region Visibility
    internal static void UpdateBooleanContainerVisibility(SerializedProperty toggleProperty, VisualElement container)
    {
        if (container == null)
            return;
