...
public static class GameHudManagerPresetBakeUtility
{
    ...
    public static GameHudRuntimeConfig BuildConfig(GameHudManagerPreset preset)
    {
        ...
        return new GameHudRuntimeConfig
        {
            ...
            SynchroSingleRankAccelerateWavesWithProgress = ToByte(synchroMeterSettings == null || synchroMeterSettings.SingleRankAccelerateWavesWithProgress),
            SynchroSingleRankMaximumWaveScrollCyclesPerSecond = synchroMeterSettings != null ? synchroMeterSettings.SingleRankMaximumWaveScrollCyclesPerSecond : 0.3f,
            SynchroSingleRankConvergenceMode = synchroMeterSettings != null ? synchroMeterSettings.SingleRankConvergenceMode : GameHudSynchroSingleRankConvergenceMode.Linear,
            SynchroSingleRankInitialPhaseOffsetNormalized = synchroMeterSettings != null ? synchroMeterSettings.SingleRankInitialPhaseOffsetNormalized : 0.25f,
            SynchroSingleRankFinalPhaseOffsetNormalized = synchroMeterSettings != null ? synchroMeterSettings.SingleRankFinalPhaseOffsetNormalized : 0f,
            SynchroSingleRankConvergenceStartProgressPercent = synchroMeterSettings != null ? synchroMeterSettings.SingleRankConvergenceStartProgressPercent : 0f,
            SynchroSingleRankConvergenceEndProgressPercent = synchroMeterSettings != null ? synchroMeterSettings.SingleRankConvergenceEndProgressPercent : 100f,
            SynchroSingleRankConvergenceStepCount = synchroMeterSettings != null ? synchroMeterSettings.SingleRankConvergenceStepCount : 5,
