...
public static class GameAudioDefaultEventDefinitions
{
    ...
    private static readonly GameAudioDefaultEventDefinition[] definitions =
    {
        ...
        new GameAudioDefaultEventDefinition(GameAudioEventId.PlayerDeathJingle,
                                            "MC_SFX_Misc_DeathJingle",
                                            "Player Death Jingle",
                                            "Requested on the first active frame of the player death animation."),
