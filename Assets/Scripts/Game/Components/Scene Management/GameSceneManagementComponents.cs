...
public struct GameSceneManagerConfig : IComponentData
{
    ...
    public GameSceneFadeVisualStyle FadeVisualStyle;
    ...
    public float FadePaintEdgeSoftness;
    public float FadePaintNoiseStrength;
    public float FadePaintNoiseScale;
    public float FadePaintBristleStrength;
    public float FadePaintBristleScale;
...
public struct GameSceneFadePresentationState : IComponentData
{
    ...
    public GameUiPaintRevealOperation Operation;
